...
func main() {
	...
	consumerSubCmd.StringVar(&redisChannel, "redisChan", "inquiry-response", "Redis channel to listen")
	...
	httpSubCmd.StringVar(&redisChannel, "redisChan", "inquiry-response", "Redis channel to listen")
